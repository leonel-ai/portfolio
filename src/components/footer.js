...
<Fade bottom>
    <div class="container text-center text-md-left">
      <div class="row text-center text-md-left mt-3 pb-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-2 mx-auto mt-3">
          <h6 class="text-uppercase mb-2">Contact</h6>
          <p>
            <i class="fa fa-home "></i>Based in Houston, TX 77006<br/>
            <i class="fa fa-envelope"></i>Reach me by <a href="mailto:leonela.dev@gmail.com?subject=Let's talk.&body=Psst! Be sure to include the essentials: Name, Contact, Company and Website (if it exists)!"><span className="cta"> Email</span></a> or
            <i class="fa fa-phone"></i><a href="sms:3372400858"> <span className="cta">Text</span></a></p>
        </div>

          {/* <hr class="w-100 clearfix d-md-none mt-0 mb-1"/> */}

        <div class="col-md-6 col-lg-5 col-xl-6 mt-3">
